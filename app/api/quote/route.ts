...
export async function POST(req: Request){
 try{
  ...
  if(!r.ok) return NextResponse.json({ok:false,error:'E-posta gönderilemedi. Kayıt veritabanına alınmış olabilir; lütfen WhatsApp üzerinden de ulaşın.'},{status:502});
